---
title: Gemini
description: Use Google's native Gemini API for completions, streaming, tools, thinking, multimodal input, embeddings, Responses, and model discovery.
---
...
Set `stream: true` to receive the OpenAI Responses event lifecycle. Vertex AI keeps Responses
